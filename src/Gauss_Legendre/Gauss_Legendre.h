    ...
    */
    ...
    public:
        ...
        */
        ...
        double qgauss(myfunctional::Functional<FUNCTYPE> const & func, bool usesimd, double x1, double x2) const noexcept;
    ...
    private:
        ...
        */
        std::vector<double, boost::alignment::aligned_allocator<double, 64> > w_;

        //! A private member variable.
        /*!
            Gauss-Legendreの節（alignmentが揃っている）
        */
        std::vector<double, boost::alignment::aligned_allocator<double, 64> > x_;
	...
	template <typename FUNCTYPE>
    inline double Gauss_Legendre::qgauss(myfunctional::Functional<FUNCTYPE> const & func, bool usesimd, double x1, double x2) const noexcept
    {
